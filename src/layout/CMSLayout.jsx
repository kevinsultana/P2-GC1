      ...
      <div className="flex flex-1">
        ...
        <aside
          className={`
            ...
            } bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700  py-6 px-4  transition-all duration-300 ease-in-out  flex flex-col flex-shrink-0 shadow-md overflow-hidden`}
        >
          {/* Menu Toggle Button */}
          <button
            onClick={() => setIsSideBarOpen(!isSideBarOpen)}
            className="self-end p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors mb-6"
          >
